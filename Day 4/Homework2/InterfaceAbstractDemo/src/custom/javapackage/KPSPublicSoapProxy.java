...
public class KPSPublicSoapProxy implements custom.javapackage.KPSPublicSoap {
  private String _endpoint = null;
  private custom.javapackage.KPSPublicSoap kPSPublicSoap = null;
  ...
  private void _initKPSPublicSoapProxy() {
    try {
      kPSPublicSoap = (new custom.javapackage.KPSPublicLocator()).getKPSPublicSoap();
  ...
  public custom.javapackage.KPSPublicSoap getKPSPublicSoap() {
    if (kPSPublicSoap == null)
      _initKPSPublicSoapProxy();

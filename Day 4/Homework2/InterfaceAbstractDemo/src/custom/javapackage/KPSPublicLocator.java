...
package custom.javapackage;

public class KPSPublicLocator extends org.apache.axis.client.Service implements custom.javapackage.KPSPublic {
    ...
    public custom.javapackage.KPSPublicSoap getKPSPublicSoap() throws javax.xml.rpc.ServiceException {
    ...
    public custom.javapackage.KPSPublicSoap getKPSPublicSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            custom.javapackage.KPSPublicSoapStub _stub = new custom.javapackage.KPSPublicSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (custom.javapackage.KPSPublicSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                custom.javapackage.KPSPublicSoapStub _stub = new custom.javapackage.KPSPublicSoapStub(new java.net.URL(KPSPublicSoap_address), this);
                _stub.setPortName(getKPSPublicSoapWSDDServiceName());
                return _stub;
            }
        }
